...
export default function VideMaisonPage() {
    ...
    useEffect(() => {
        document.title = 'Vide-Maisons et Ventes de Succession - GoChineur'
        const metaDesc = document.querySelector('meta[name="description"]')
        if (metaDesc) {
            metaDesc.setAttribute('content', 'Agenda des vide-maisons et ventes de succession en France. Trouvez les meilleures opportunités d\'achat près de chez vous.')
        }
    }, [])
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto px-4 py-6">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-text-primary mb-4">
                    Vide-Maisons et Ventes de Succession autour de moi
                </h1>
                            ...
                            <>
                                <div className="space-y-8">
                                    {groupedEvents.map((group) => {
                                        ...
                                        const h2Label = isToday ? 'Vide-maisons aujourd\'hui' : group.label
