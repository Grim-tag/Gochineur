...
export default function TrocPage() {
    ...
    useEffect(() => {
        document.title = 'Troc et Échange gratuit autour de moi - GoChineur'
        const metaDesc = document.querySelector('meta[name="description"]')
        if (metaDesc) {
            metaDesc.setAttribute('content', 'Découvrez tous les événements de troc et d\'échange gratuit en France. Donnez une seconde vie à vos objets et faites des économies.')
        }
    }, [])
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto px-4 py-6">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-text-primary mb-4">
                    Troc et Échange : Événements gratuits autour de moi
                </h1>
                            ...
                            <>
                                <div className="space-y-8">
                                    {groupedEvents.map((group) => {
                                        ...
                                        const h2Label = isToday ? 'Événements de troc aujourd\'hui' : group.label
