...
export default function Footer() {
    ...
    return (
        <footer className="bg-gray-800 text-gray-300 py-6 md:py-8 mt-8 md:mt-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
                    <div>
                        <h3 className="text-white font-bold text-lg mb-2 md:mb-4">GoChineur</h3>
                        <p className="text-sm">
                            L'agenda de référence pour les vide-greniers, brocantes et bourses aux collections en France.
                        </p>
                    </div>
                    <div>
                        <h3 className="text-white font-bold text-lg mb-2 md:mb-4">Liens utiles</h3>
                ...
                <div className="border-t border-gray-700 pt-6 md:pt-8">
                    <h3 className="text-white font-bold text-sm mb-3 md:mb-4">Vide-greniers par département</h3>
                ...
                <div className="border-t border-gray-700 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-xs">
